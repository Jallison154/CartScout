...
import { getListsForUser, getListForUserWithItems, requireListForUser, getListStoreIds, createList, updateList, deleteList, setListStores, addListItem, updateListItem, deleteListItem, } from "../services/lists.service.js";
import { parseCreateListBody, parseUpdateListBody, parseAddListItemBody, parseUpdateListItemBody, parseSetListStoresBody, } from "../validators/lists.validator.js";
const router = Router();
...
router.get("/:id/stores", asyncHandler(async (req, res) => {
    const userId = req.userId;
    const { id } = req.params;
...
router.put("/:id/stores", asyncHandler(async (req, res) => {
    const userId = req.userId;
    const { id } = req.params;
