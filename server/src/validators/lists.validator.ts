...
export const addListItemBodySchema = z.object({
  ...
  (data) =>
    (typeof data.canonical_product_id === "string" && data.canonical_product_id.trim() !== "") ||
    (typeof data.free_text === "string" && data.free_text.trim() !== ""),
  { message: "Provide canonical_product_id or free_text" }
);
...
export type SetListStoresBody = z.infer<typeof setListStoresBodySchema>;
...
export function parseCreateListBody(body: unknown): CreateListBody {
...
export function parseUpdateListBody(body: unknown): UpdateListBody {
...
export function parseAddListItemBody(body: unknown): AddListItemBody {
...
export function parseUpdateListItemBody(body: unknown): UpdateListItemBody {
...
export function parseSetListStoresBody(body: unknown): SetListStoresBody {
